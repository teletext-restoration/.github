...
This archive grew out of the efforts to archive Digitiser and Turner the Worm from recordings of Channel 4/S4C, but has since grown to include thousands of individual recoveries from dozens of different channels, catalogued in one place.
...
Yes please! Drop us an email at <archive@zxnet.co.uk> to discus the logistics.
...
There are many tasks that people can work on outside of the recovery process itself, like working on an archive sub-project (i.e. restoring the pages of a particular magazine section), or cataloguing batches of submitted recoveries.

The project team mostly coordinate activity through the [teletext discord server](https://discord.gg/JfytfS3xmg). If you make yourself known there, or contact <archive@zxnet.co.uk> we can discuss you joining the team.
